...
class SignupKaryawan extends StatefulWidget {
  const SignupKaryawan({Key key}) : super(key: key);

  @override
  State<SignupKaryawan> createState() => _SignupKaryawanState();
}

class _SignupKaryawanState extends State<SignupKaryawan> {
  void initState() {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    decoration: InputDecoration(
                      hintText: "Tahun Keluar (jika tidak aktif)",
                      prefixIcon: Padding(
                          padding: EdgeInsets.only(right: 10),
                          child: Icon(Icons.business)),
                    ),
